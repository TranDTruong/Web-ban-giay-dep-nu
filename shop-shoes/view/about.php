    ...
    <div class="container">
        <div class="row row-pb-lg">
            <div class="col-sm-6 mb-3">
                <div class="video colorlib-video" style="background-image: url('webroot/image/logo/logo-shop-nu.jpg');">
            ...
            <div class="col-sm-6">
                <div class="about-wrap">
                    <h2>Shop Shoes - Cửa hàng giày dép nữ hàng đầu trên toàn cầu</h2>
                    <p>"Cửa hàng giày dép nữ chuyên cung cấp các loại giày, dép thời trang đa dạng và phong cách. Khách
                        hàng có thể
                        tìm thấy một bộ sưu tập đa dạng của giày dép sneakers, giày dép cao gót, giày dép thể thao và
                        nhiều loại
                        giày dép khác. Cửa hàng giày cam kết mang đến cho khách hàng những sản phẩm chất lượng, thời
                        trang
