                    ...
                    <div class="one-eight text-center">
                        <div class="display-tc">
                            <span id="total-price-<?php echo $item_cart['MaSP']; ?>" class="price">
                                <?php $number = str_replace(',', '', $item_cart['DonGia']); echo number_format($number * $item_cart['SoLuong']); ?>
                            </span>
                            ...
                            <div class="total">
                                <div class="sub">
                                    <p><span>Tạm tính:</span> <span
                                            id="subtotal"><?php if(isset($_SESSION['cart_product'])){ echo number_format($subtotal);}else echo '0'; ?></span>
                                    </p>
                                    <p><span>Giảm giá:</span> <span id="coupon_apply">0</span></p>
                                </div>
                                <div class="grand-total">
                                    <p><span><strong>Tổng cộng:</strong></span> <span
                                            id="total"><?php if(isset($_SESSION['cart_product'])){ echo number_format($subtotal);}else echo '0'; ?></span>
                                    </p>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <form action="?view=thanhtoan2" method="post">
                                    ...
                                    <input type="hidden" name="tamtinh" value="<?php echo $subtotal; ?>">
