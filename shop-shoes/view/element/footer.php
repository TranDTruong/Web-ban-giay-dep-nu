            ...
            <div class="col-5 footer-col colorlib-widget ">
                <div class="d-flex justify-content-center align-items-center ">
                    <div id="colorlib-logo">
                        <a href="?view">
                            <img class="logo-header custom-circle rounded-circle"
                                src="webroot/image/logo/logo-shop-nu.jpg" alt="">
                        </a>
                    </div>
                </div>
                <h4 class="text-white">Shop Shoes - Giày Dép Nữ đến từ Châu Á </h4>
                <p class="text-white">
                    Khu Minh Khai, Cầu Diễn, Nam Từ Liêm, Hà Nội</p>
            </div>
