...
<head>
    <title>GIÀY DÉP NỮ - SHOP SHOES</title>
    <meta charset="utf-8">
    <link rel="icon" href="https://ibrand.vn/wp-content/uploads/2022/10/logo-shop-giay-5.jpg">
                    ...
                    <div class="row">
                        <div class="col-sm-7 col-md-4">
                            <div id="colorlib-logo">
                                <a href="?view">
                                    <img class="logo-header" src="webroot/image/logo/logo-shop-nu.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-5 col-md-3">
                            <a href="?view=user"><i class=" fas fa-user i-use"></i>&emsp;<?php //echo $kh['TenKH']?></a>
                        </div>
                    </div>
                    <div class="row">
