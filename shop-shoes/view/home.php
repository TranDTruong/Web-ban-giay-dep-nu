<aside id="colorlib-hero">
    <div class="flexslider">
        <ul class="slides">
            <li style="background-image: url(webroot/image/slider/banner4.jpg);">
                <div class="overlay"></div>

            </li>

            <li style="background-image: url('webroot/image/slider/slide-giay-nu.jpg');">
                <div class="overlay"></div>
